...
export default function DailyLife() {
  ...
  const subContexts = [
    ...
    { id: 'shopping-services', label: 'Shopping & Services', icon: '🛒' },
    { id: 'daily-routines', label: 'Daily Routines', icon: '🌅' },
  ];

  const filteredMaterials = activeSubContext === 'all'
    ? materials
    : materials.filter(m => m.tags?.some(tag => tag.includes(activeSubContext.replace('-', ''))));
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-600">
            Real-world vocabulary and phrases for everyday situations
          </p>
        </div>
