...
export default function Resources() {
  ...
  const subContexts = [
    ...
    { id: 'reference', label: 'Reference Books', icon: '📕' },
    { id: 'lesson', label: 'Lesson Notes', icon: '📝' },
  ];

  const filteredMaterials = activeSubContext === 'all'
    ? materials
    : materials.filter(m => {
        if (activeSubContext === 'reference') {
          return m.category === 'reference';
        }
        if (activeSubContext === 'lesson') {
          return m.category === 'lesson';
        }
        return true;
      });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-600">
            Reference books and personal lesson notes
          </p>
        </div>
